...
Purpose of script: Calculate where Horn species are in exceedance according to the individual response curves
...
# Set tdep raster paths n_tw_1719  or s_tw_1719 [e.g., 2000-2002 run]
